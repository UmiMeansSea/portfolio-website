...
const Page2 = React.forwardRef((props, ref) => {
  return (
    <div ref={ref} className="bg-white relative size-full" {...props} data-node-id="9:358" data-name="page2">
      <div className="absolute contents left-[-62px] top-0" data-node-id="32:338" data-name="table n portfolio">
        <div className="absolute flex h-[1142px] items-center justify-center left-[-62px] top-0 w-[1714px]" data-node-id="32:339">
        ...
        <div className="absolute contents left-[893px] top-[150px]" data-node-id="32:340">
          <a className="absolute bg-[#f7f5f5] block border border-[rgba(0,0,0,0.5)] border-solid cursor-pointer h-[103px] left-[927px] shadow-[-4px_4px_4px_0px_rgba(0,0,0,0.25)] top-[1039px] w-[579px]" onClick={(e) => { e.preventDefault(); props.onToggleResume && props.onToggleResume(true); }} data-node-id="32:341" />
          <div className="absolute h-[30px] left-[962px] top-[1112px] w-[94px]" data-node-id="32:393" data-name="image 26">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <img alt="" className="absolute h-[403.65%] left-0 max-w-none top-[-0.26%] w-full" src={imgImage26} />
            </div>
          </div>
          <p className="[word-break:break-word] absolute font-['Caveat_Brush:Regular'] h-[118px] leading-[normal] left-[893px] not-italic text-[#4c3131] text-[128px] top-[150px] w-[482px]" data-node-id="32:342">
            portfolio
          </p>
        </div>
        <p className="[word-break:break-word] absolute font-['Actor:Regular'] h-[61px] leading-[normal] left-[1192px] not-italic text-[24px] text-black top-[1068px] w-[230px]" data-node-id="32:343">
          Resume
        </p>
      </div>
      <div className="absolute contents cursor-pointer left-[428px] top-[79px]" data-node-id="9:374" data-name="bookmark">
        <a className="absolute contents left-[1268px] top-[101px]" data-node-id="9:362" data-name="Creativity" onClick={(e) => { e.preventDefault(); props.onBookmarkClick && props.onBookmarkClick(6); }}>
          <div className="absolute bg-[rgba(45,216,202,0.8)] border border-[rgba(4,1,1,0.2)] border-solid h-[71px] left-[1268px] top-[101px] w-[61px]" data-node-id="9:363" />
          <div className="absolute flex h-[28.48px] items-center justify-center left-[1277px] top-[117px] w-[43.632px]" data-node-id="9:364">
        ...
        <a className="absolute contents left-[1189px] top-[93px]" data-node-id="9:359" data-name="Highlights" onClick={(e) => { e.preventDefault(); props.onBookmarkClick && props.onBookmarkClick(2); }}>
          <div className="absolute bg-[rgba(216,119,45,0.8)] border border-[rgba(4,1,1,0.2)] border-solid h-[58px] left-[1189px] top-[93px] w-[61px]" data-node-id="9:360" />
          <div className="absolute flex h-[26.905px] items-center justify-center left-[1189.31px] top-[103.43px] w-[63.667px]" data-node-id="9:361">
        ...
        <a className="absolute contents left-[428px] top-[79px]" data-node-id="9:366" data-name="Home" onClick={(e) => { e.preventDefault(); props.onBookmarkClick && props.onBookmarkClick(0); }}>
          <div className="absolute bg-[#cf7ab3] border border-[rgba(4,1,1,0.2)] border-solid h-[73px] left-[428px] top-[79px] w-[61px]" data-node-id="9:367" />
          <div className="absolute flex h-[25.422px] items-center justify-center left-[444px] top-[89.31px] w-[55.265px]" data-node-id="9:368">
      ...
      <div className="absolute border border-[red] border-solid h-[842px] left-[200px] overflow-clip shadow-[-11px_4px_4px_0px_rgba(0,0,0,0.25)] top-[150px] w-[1190px]" data-node-id="6:153">
        ...
        <div className="absolute contents left-[calc(50%_+_299px)] top-[510px]" data-node-id="17:16" data-name="sticky note">
          <div className="absolute h-[338px] left-[calc(50%_+_299px)] top-[511px] w-[321px]" data-node-id="17:3" data-name="sticky note">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgStickyNote} />
          </div>
          <div className="absolute flex h-[39.722px] items-center justify-center left-[calc(50%_+_433.52px)] top-[597.64px] w-[101.965px]" data-node-id="17:5">
        ...
        <div className="absolute h-[209px] left-[92px] shadow-[-1px_4px_4px_0px_rgba(0,0,0,0.25)] top-[291px] w-[192px]" data-node-id="74:3" data-name="image 32">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage32} />
        </div>
        <div className="absolute h-[169px] left-[calc(50%_+_111px)] shadow-[-3px_4px_4px_0px_rgba(0,0,0,0.25)] top-[67px] w-[355px]" data-node-id="74:6" data-name="image 33">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute h-[115.38%] left-[-3.39%] max-w-none top-[-15.38%] w-[103.4%]" src={imgImage33} />
          </div>
        </div>
        <div className="absolute h-[128px] left-[292px] shadow-[-3px_4px_4px_0px_rgba(0,0,0,0.25)] top-[570px] w-[270px]" data-node-id="77:9" data-name="image 34">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute contents left-[18px] top-[4px]" data-node-id="17:23" data-name="tape">
          ...
          <div className="absolute flex h-[69.987px] items-center justify-center left-[256px] top-[532px] w-[73.439px]" data-node-id="17:12">
          ...
          <div className="absolute flex h-[75.167px] items-center justify-center left-[527px] top-[532px] w-[71.867px]" data-node-id="17:14">
        ...
        <p className="[word-break:break-word] absolute font-['Caveat_Brush:Regular'] h-[88px] leading-[normal] left-[142px] not-italic text-[#4c3131] text-[128px] top-[72px] w-[372px]" data-node-id="9:375">
          Projects
        </p>
        <div className="absolute flex h-[192.184px] items-center justify-center left-[calc(50%_+_341px)] top-[627px] w-[215.474px]" data-node-id="60:2">
        ...
        <div className="[word-break:break-word] absolute font-['Actor:Regular'] h-[178px] leading-[0] left-[333px] not-italic text-[0px] text-black top-[269px] w-[225px]" data-node-id="60:79">
        ...
        <div className="[word-break:break-word] absolute font-['Alan_Sans:Regular'] h-[264px] leading-[0] left-[calc(50%_+_42px)] not-italic text-[20px] text-black top-[246px] w-[480px]" data-node-id="60:88">
        ...
        <div className="[word-break:break-word] absolute font-['Alan_Sans:Regular'] leading-[0] left-[60px] not-italic text-[16px] text-black top-[551px] w-[238px]" data-node-id="69:2">
      ...
      <div className="absolute contents left-[357px] top-[89px]" data-node-id="9:370" data-name="bookmark active">
        <div className="absolute bg-[rgba(45,136,216,0.8)] border border-[rgba(4,1,1,0.2)] border-solid h-[151px] left-[357px] top-[89px] w-[61px]" data-node-id="9:371" />
        <div className="absolute flex h-[52.585px] items-center justify-center left-[360px] top-[106.03px] w-[55.265px]" data-node-id="9:372">

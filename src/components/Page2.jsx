...
const Page2 = React.forwardRef((props, ref) => {
  return (
    <div ref={ref} className="bg-transparent relative w-[1590px] h-[1142px]" {...props} data-node-id="9:358" data-name="page2">
      <div className="absolute contents left-[-62px] top-0" data-node-id="32:338" data-name="table n portfolio">
        ...
        <div className="absolute contents left-[893px] top-[150px]" data-node-id="32:340">
          ...
          <p className="[word-break:break-word] absolute font-brush h-[118px] leading-[normal] left-[893px] not-italic text-[#4c3131] text-[128px] top-[150px] w-[482px]" data-node-id="32:342">
            portfolio
          </p>
        </div>
        <p className="[word-break:break-word] absolute font-heading-zine h-[61px] leading-[normal] left-[1192px] not-italic text-[24px] text-black top-[1068px] w-[230px]" data-node-id="32:343">
          Resume
        </p>
      </div>
      ...
      <div className="absolute border border-[red] border-solid h-[842px] left-[200px] overflow-clip shadow-[-11px_4px_4px_0px_rgba(0,0,0,0.25)] top-[150px] w-[1190px]" data-node-id="6:153">
        ...
        <p className="[word-break:break-word] absolute font-brush h-[88px] leading-[normal] left-[142px] not-italic text-[#4c3131] text-[128px] top-[72px] w-[372px]" data-node-id="9:375">
          Projects
        </p>
        ...
        <div className="[word-break:break-word] absolute font-heading-zine h-[178px] leading-[0] left-[333px] not-italic text-[0px] text-black top-[269px] w-[225px]" data-node-id="60:79">
        ...
        <div className="[word-break:break-word] absolute font-body-zine h-[264px] leading-[0] left-[calc(50%_+_42px)] not-italic text-[20px] text-black top-[246px] w-[480px]" data-node-id="60:88">
        ...
        <div className="[word-break:break-word] absolute font-body-zine leading-[0] left-[60px] not-italic text-[16px] text-black top-[551px] w-[238px]" data-node-id="69:2">
